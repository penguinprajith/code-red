/*
	...
	integers on a single line; the number of pieces of each type Mirko should add or remove. 
...
int rook(int input)
{
    return check(2,input);
}

int bishop(int input)
{
    return check(2,input);
}

int knight(int input)
{
    return check(2,input);
}
